...
$query_result = mysqli_query($db,"SELECT * FROM dba_table_info WHERE table_name='transactions'");
...
if (isset($_POST['submitted']))
{
  if (!DateIsValid($_POST['date_selection']))
	...
	{
		$query_result = mysqli_query($db,"SELECT * FROM $table WHERE date>'{$_POST['date_selection']}'");
