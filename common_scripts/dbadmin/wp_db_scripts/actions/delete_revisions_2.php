...
<?php
	...
	$where_values = array();
	$query_result = mysqli_free_format_query($db,"SELECT post_id,post_name FROM wp_postmeta LEFT JOIN wp_posts ON wp_posts.ID=wp_postmeta.post_ID WHERE ID IS NULL",$where_values);
