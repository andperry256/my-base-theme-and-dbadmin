...
function my_base_theme_scripts()
{
    ...
    if (!isset($last_preset_link_version)) {
        $last_preset_link_version = date('ym').'01';
    }
    ...
    if (!is_child_theme()) {
        wp_enqueue_style( 'my-base-theme-style', $stylesheet_uri, '', $last_preset_link_version );
    }

    wp_enqueue_script( 'my-base-theme-navigation', get_template_directory_uri() . '/js/navigation.js', [], $last_preset_link_version, true );

    wp_enqueue_script( 'my-base-theme-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', [], $last_preset_link_version, true );
